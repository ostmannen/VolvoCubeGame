...
public class PostProcessingBehaviour : MonoBehaviour
{
    ...
    public void LensDistortionChanged(bool initiate)
    {
        ...
        if (initiate)
        {
            StartCoroutine(ChangeLensDistortion(0.1f, 100,_defaultLensDist, _flyingLensDist));
        }
        else
        {
            StartCoroutine(ChangeLensDistortion(0.03f, 100, _flyingLensDist, _defaultLensDist));    
        }
